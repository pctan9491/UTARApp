...
public class TimetableManagementWebViewActivity extends AppCompatActivity {
    private WebView webView;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.timetable_management_web_view); // Ensure you have this layout file with a WebView

        webView = (WebView) findViewById(R.id.timetable_web_view); // Make sure your WebView in the layout has this ID
        ...
        webView.loadUrl("https://pctan9491.github.io/UTARApp_admin/timetable.html");
    }
